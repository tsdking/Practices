 ...
 * DAO for table "GANK".
*/
public class GankDao extends AbstractDao<Gank, Void> {
    ...
    public static class Properties {
        ...
        public final static Property Collect = new Property(10, int.class, "collect", false, "COLLECT");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GANK\" (" + //
                ...
                "\"WHO\" TEXT," + // 8: who
                "\"IMAGE\" TEXT," + // 9: image
                "\"COLLECT\" INTEGER NOT NULL );"); // 10: collect
    }
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Gank entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(11, entity.getCollect());
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, Gank entity) {
        stmt.clearBindings();
    ...
    public Gank readEntity(Cursor cursor, int offset) {
        Gank entity = new Gank( //
            ...
            cursor.getInt(offset + 10) // collect
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Gank entity, int offset) {
        ...
        entity.setCollect(cursor.getInt(offset + 10));
     }
    
    @Override
    protected final Void updateKeyAfterInsert(Gank entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Gank entity) {
        return null;
    }

    @Override
    public boolean hasKey(Gank entity) {
        // TODO
        return false;
    }
