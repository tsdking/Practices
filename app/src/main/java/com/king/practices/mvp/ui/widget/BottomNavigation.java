...
public class BottomNavigation extends BottomNavigationView {
    ...
    private BottomNavigationOnPageChangeListener mPageChangeListener;
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    /**
     * This method will link the given ViewPager and this BottomNavigation together so that
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager, boolean smoothScroll) {
        ...
        if (mPageChangeListener == null) {
            mPageChangeListener = new BottomNavigationOnPageChangeListener(this);
        }
     ...
     * kept in sync.
     * <p>
     * <p>This class stores the provided BottomNavigation weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    private static class BottomNavigationOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavigation> mBnveRef;

        public BottomNavigationOnPageChangeListener(BottomNavigation bnve) {
