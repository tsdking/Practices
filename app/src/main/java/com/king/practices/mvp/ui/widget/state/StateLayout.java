...
public class StateLayout extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        if (progressViewId != -1) {
            ...
            progressView = inflater.inflate(R.layout.view_state_progress, this, false);
        ...
        errorView = inflater.inflate(R.layout.view_state_error, this, false);
        ...
        emptyView = inflater.inflate(R.layout.view_state_empty, this, false);
